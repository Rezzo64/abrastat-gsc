...
enum class Status(val volatility: Volatility, private val target: Target) {
    ...
    BIND(Volatility.VOLATILE, Target.OPPONENT),
    ...
    FOCUSENERGY(Volatility.VOLATILE, Target.SELF),
    FORESIGHT(Volatility.VOLATILE, Target.OPPONENT),
    HAZE(Volatility.VOLATILE, Target.OPPONENT),
    HYPERBEAM(Volatility.VOLATILE, Target.OPPONENT),
    INVULNERABLE(Volatility.VOLATILE, Target.SELF),
    ...
    MIST(Volatility.VOLATILE, Target.SELF),
    ...
    RAGE(Volatility.VOLATILE, Target.SELF),
