...
//         }
    ...
    public void initIVs()   {
        ...
        this.setIvAtk(maxDV);
        this.setIvDef(maxDV);
        this.setIvSpecial(maxDV);   // special attack and special defense share the same DV
        this.setIvSpe(maxDV);
        this.calculateIvHP();             // generated by the result of other DVs
    }
    ...
    */
    ...
    // instead, use the "setIvSpecial(DV)" and "calculateIvHP()" methods
    @Override
